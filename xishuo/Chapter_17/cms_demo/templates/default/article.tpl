<{ include file="default/header.inc.tpl" }>
	<div id="main">
		...
		<div class="article">
			<div class="dt"><strong><a href="comments.php?aid=<{ $aid }>">发表评论</a></strong><span class="more"><a href="comments.php?aid=<{ $aid }>">查看全部评论(<{ cacheless }><span class="red"><{ $commTotal }></span><{ /cacheless }>)篇>></a></span></div>			<{ cacheless }>
