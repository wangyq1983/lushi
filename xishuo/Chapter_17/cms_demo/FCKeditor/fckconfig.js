...
FCKConfig.ToolbarSets["Default"] = [
	['Source','Preview','-','PasteText','PasteWord','-','RemoveFormat','-','Undo','Redo','-','Bold','Italic','Underline','StrikeThrough','-','OrderedList','UnorderedList','-','Outdent','Indent'],
	['JustifyLeft','JustifyCenter','JustifyRight','-','Link','Unlink','Anchor','-','TextColor','BGColor'],
	'/',
	['FontFormat','FontName','FontSize'],
	['Image','-','DedePage','Quote','Br','-','Rule','Codes','Table','Smiley']
] ;
